...
const deleteTask = (e) => {
  ...
  updateLocalStorage();
  //this is for the complete button
  if (type === "BUTTON") {
    return e.target.parentNode.parentNode.parentNode.parentNode.removeChild(
      //return is accessing one parent above what we want to delete
      e.target.parentNode.parentNode.parentNode
    );
  }

  //this is for the trash icon we have
...
const saveEdit = (e) => {
  ...
  const taskTitle = parentNode.childNodes[3].childNodes[3]; //Accessing card title
  // console.log(taskTitle);
  const taskDescription = parentNode.childNodes[3].childNodes[5]; // Accessing description
  // console.log(taskDescription);
  const taskType = parentNode.childNodes[3].childNodes[7].childNodes[1]; // Accessing task type
  // console.log(taskType);
  const submitButton = parentNode.childNodes[5].childNodes[1]; // targeting open task button
